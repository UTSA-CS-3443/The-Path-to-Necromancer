...
public class Necromancer extends CharacterSprites implements InteractionSprites{
	...
	private DialogueGraph getCastleEncounter() {
		...
		graph.addNode("Well well well. Look who decided to show up? I set this banquet out and you leave me waiting here for an eternity?");
		graph.addNode("It hasn’t been an eternity?");
		graph.addNode("When you live forever, time has no meaning anymore than just being a chore, and when you don’t need to eat and prepare a feast for someone who doesn’t show up … you get a little upset.");
		graph.addNode("You made all this for me?");
		graph.addNode("That must be lonely?");
		graph.addNode("Where did you get this food from if you don’t need to eat?");
		graph.addNode("Of course I made it for you. Who else would come out here? Door to door salesmen? No I killed all of them ages ago, damn shamwow never absorbed all the blood.");
		graph.addNode("Thank you, I think?");
		graph.addNode("Those poor salesmen!");
		graph.addNode("Did you try using some bleach?");
		graph.addNode("You are welcome, now sit down so you can have your last meal and I can kill you. It is a bit of tradition for me with heroes now.");
		graph.addNode("But why?");
		graph.addNode("Look when I see you young heroes come in here honestly I get hopeful that maybe you will be the one to end my eternity, but you always die. I might as well give you a good final meal. Forgive the lack of variety, the only thing that grows in this kingdom anymore is wheat.");
		graph.addNode("I will defeat you!");
		graph.addNode("Many have tried and all have failed, no hero. Sit down please and eat, don’t let your last moments be spent in hungering agony as well.");
		graph.addNode("*Eat*");
		graph.addNode("*Attempt to fight*");
		graph.addNode("Thank you, now get some good rest in my dungeon, The General shall escort you for a good nap.");
		graph.addNode("YOU KNOW WHAT? FINE, YOU GET YOUR BATTLE ON AN EMPTY STOMACH, BUT FIRST … GENERAL ESCORT THE HERO TO THE DUNGEON!");
		graph.addNode("They are salesmen, merchants no one will miss. Besides they are all cons anyway. Shame I never got my money back though.");
		graph.addNode("I will avenge those salesmen!");
		graph.addNode("Yeah they are truly the worst of merchants.");
		graph.addNode("Very true, now get a good meal and then a nap before I destroy you.");
		graph.addNode("Bleach never works, besides it leaves behind a smell that gives me a killer headache.");
		graph.addNode("But you can’t smell?");
		graph.addNode("HOW WOULD YOU KNOW? Sorry, sorry. It has been a long day and I just wish to destroy you, I was gonna let you eat this fine feast but now … now I am just gonna send you to the dungeon and fight you when I am calmer. Bye!");
		graph.addNode("What would you know of lonely? I have lived for eons with only myself, and who can call what I do living? I just go through the motions now.");
		graph.addNode("C’mon you are more than just a Necromancer, you are an icon of fear! You inspire heroes to rise up! Don’t be so down on yourself.");
		graph.addNode("Motions? What motions?");
		graph.addNode("You know, flattery won’t save you and neither will pity. Now eat your food and go take a nap in my dungeon so I can be rid of you with a clear conscience.");
		graph.addNode("Oh, you know. Kill the sick and raise them as undead to watch over their towns and continue with their jobs. Hire bandits to keep the normal humans safe from the horrifying mushrooms on the mountains. Hire a poor knight who was looking for a master to serve and gave them a roof to sleep under and purpose.");
		graph.addNode("WAIT WHAT?");
		graph.addNode("Hmmm?");
		graph.addNode("NO YOU CAN’T BE A GOOD GUY!");
		graph.addNode("Why not? Because I am ‘evil’? Because my magic isn’t holy? Well I never asked to have these gifts. I was once praised as the savior of this very Kingdom you know? This castle was the king’s in fact.");
		graph.addNode("…");
		graph.addNode("He was a good man, but he asked me for too much, his greed took over him and I had to leave him. He grew mad and so I became ‘evil’ and stopped him. In the process all of my history was destroyed and so I stay here making sure no tyrant grows again to immense power.");
		graph.addNode("But in doing so haven’t you-");
		graph.addNode("Become the very tyrant I swore to stop? Very astute of you. Why do you think I have been waiting for a hero this whole time? It was not to stop you but to find peace. You see I have been cursed to eternal life until I am slain by a true hero.");
		graph.addNode("…");
		graph.addNode("How about you? Will you be the one to end my suffering?");
		graph.addNode("Yes");
		graph.addNode("Yes, but I would like to save you, not end you. (good ending ask Jamie to explain)");
		graph.addNode("Thank you, now get some good food and a good rest. I look forward to our fight.");
		graph.addNode("What do you mean save me?");
		graph.addNode("You are a good man, I wish to join your cause, and save you from your loneliness.");
		graph.addNode("You cannot, you are the hero! You must either end me or die by my hands, there is no saving!");
		graph.addNode("But what if I followed in your footsteps? I already organized your bandit camp, and took care of the villagers with the mushrooms?");
		graph.addNode("I suppose so, and you led my general towards becoming a good person again. Hmmm. Are you really willing to give up your mortality to save the world? To live forever is not an easy thing.");
		graph.addNode("Yes (good ending finale)");
		graph.addNode("NO (true evil ending finale)");
		graph.addNode("You know what? Don’t question a free lunch.");
		graph.addNode("My parents said there’s no such thing as free lunch?");
		graph.addNode("Well this one is.");
		graph.addNode("But its dinner?");
		graph.addNode("Fine, don’t question a free dinner.");
		graph.addNode("But I don’t want bread, do you have gluten free?");
		graph.addNode("… Its bread.");
		graph.addNode("Fine how about something other than root beer?");
		graph.addNode("I only have access to what I got from Oog-Lag.");
		graph.addNode("Fine then I’m not eating, let’s fight!");
		graph.addNode("YOU KNOW WHAT? DUNGEON TIME. YOU JUST TICKED ME OFF.");
