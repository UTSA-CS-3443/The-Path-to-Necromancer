...
public class Warrior extends Player {
    ...
    public Warrior() {
        ...
        super.setBaseStats(1, 0, 5, 1, 0, 2, 20);
    }
    ...
    public void setTextureValues() {
        ...
        // Use the Warrior animations until we have the player SpriteSheet
        warriorTexture = new Texture("CharacterSprites/MainCharacter-Adjusted.png");

        // Set the default standing region of the character.
        super.setStandingRegion(new TextureRegion(warriorTexture, 0, 70, width, height));
        // Array of frames used for the animations
        Array<TextureRegion> frames = new Array<TextureRegion>();

        for(int i = 0; i <= 3; i++) {
        	frames.add(new TextureRegion(warriorTexture, i*width, rowHeight, width, height));
        }
        for(int i = 2; i >= 1; i--) {
        	frames.add(new TextureRegion(warriorTexture, i*width, rowHeight, width, height));
        }
