...
public class Mage extends Player{
    ...
    public void setTextureValues() {
        ...
        // Use the Mage animations until we have the player SpriteSheet
        mageTexture = new Texture("CharacterSprites/MainCharacter-Adjusted.png");

        // Set the default standing region of the character.
        super.setStandingRegion(new TextureRegion(mageTexture, 0, 140, width, height));
        // Array of frames used for the animations
        Array<TextureRegion> frames = new Array<TextureRegion>();

        for(int i = 0; i <= 3; i++) {
        	frames.add(new TextureRegion(mageTexture, i*width, rowHeight, width, height));
        }
        for(int i = 2; i >= 1; i--) {
        	frames.add(new TextureRegion(mageTexture, i*width, rowHeight, width, height));
        }
